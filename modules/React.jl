...
function redox(
    ...
    return R_MnII_redox, R_FeII_redox, R_NH3_redox, R_H2S_redox, R_CH4_O2redox, R_CH4_SO4redox, R_FEOH3_PO4_adsorp, 
        ...
        R_FeS2_SO4_H2S_FeS, R_FeS_ox, R_FeS2_O2
end
...
function reactions2rates(
    ...
    R_FeS2_FeS_S0::Float64, R_FeS2_SO4_H2S_FeS::Float64, R_FeS_ox::Float64, R_FeS2_O2::Float64,
    ...
    rate_dtSO4 = p2d * RC * (-0.5*Rdeg_dtSO4) + R_dH2S - R_CH4_SO4redox - p2d * R_FeS2_SO4_H2S_FeS + p2d * R_FeS_ox + 4.0 * p2d * R_FeS2_O2
...
function rates(
    ...
    (Rfast_dO2, Rslow_dO2, Rfast_dtNO3, Rslow_dtNO3,
     ...
     R_FeS_H2S_Fe, R_FeS2_FeS_S0, R_FeS2_SO4_H2S_FeS, R_FeS_ox, R_FeS2_O2, Rdiss_calcite, Rdiss_aragonite, Rprec_calcite, Rprec_aragonite) =
    ...
    return reactions2rates(Rfast_dO2, Rslow_dO2, Rfast_dtNO3, Rslow_dtNO3,
                           ...
                           R_Fe_MnO2_red, R_H2S_FeOOH_PO4_red, R_H2S_FeOOH_red, R_H2S_MnO2_red, R_FeS_H2S_Fe, R_FeS2_FeS_S0, R_FeS2_SO4_H2S_FeS, R_FeS_ox, R_FeS2_O2,
                           Rdiss_calcite, Rdiss_aragonite, Rprec_calcite, Rprec_aragonite,
                           phiS_phi_z, RC, RN, RP)
end
